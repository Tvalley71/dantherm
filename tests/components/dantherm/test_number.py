...
async def test_number_setup_no_device(hass: HomeAssistant) -> None:
    """Test number setup when device is None."""
...
async def test_number_setup_missing_device_object(hass: HomeAssistant) -> None:
    """Test number setup when device object is missing."""
    mock_config_entry = AsyncMock()
    mock_config_entry.entry_id = "test_entry"
...
async def test_number_setup_success(hass: HomeAssistant) -> None:
    """Test successful number setup."""
    mock_config_entry = AsyncMock()
    mock_config_entry.entry_id = "test_entry"
...
async def test_number_setup_missing_entry(hass: HomeAssistant) -> None:
    """Test number setup when entry is missing from hass.data."""
    mock_config_entry = AsyncMock()
